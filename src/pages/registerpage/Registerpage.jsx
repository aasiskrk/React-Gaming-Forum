...
import dedsec2 from '../../assets/images/dedsec2.jpg'
          ...
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            ...
            <div class="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 class="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                Welcome to Play Forge 🎮
              </h2>

              <p class="mt-4 leading-relaxed text-white/90">
                Crafting the Ultimate Gaming Community
              </p>
            </div>
          </section>
            ...
            <div class="max-w-xl lg:max-w-3xl">
              ...
              <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                <div class="col-span-6">
                  ...
                  <input
                    onChange={handleFullName} className="form-control" placeholder="Enter Your Full Name"
                    type="text"
                    id="FullName"
                    name="full_name"
                    class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm  text-black shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 py-3 px-2"
                  />
                  {
                ...
                <div class="col-span-6">
                  ...
                  <input
                    onChange={handleEmail} className="form-control" placeholder="Enter Email Address"
                    type="text"
                    id="Email"
                    name="email"
                    class="mt-1 w-full rounded-md py-3 px-2 border-gray-200 bg-white text-sm text-black shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                  />
                ...
                <div class="col-span-6">
                  ...
                  <input
                    onChange={handlePhone} className="form-control" placeholder="Enter Phone Number"
                    type="text"
                    id="Phone"
                    name="phone"
                    class="mt-1 w-full rounded-md py-3 px-2 border-gray-200 bg-white text-sm text-black shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                ...
                <div class="col-span-6">
                  ...
                  <input
                    onChange={handleAddress} className="form-control" placeholder="Enter Address"
                    type="text"
                    id="Address"
                    name="address"
                    class="mt-1 w-full rounded-md py-3 px-2 border-gray-200 bg-white text-sm text-black shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input
                    onChange={handlePassword} className="form-control" placeholder="Enter Password"
                    type="password"
                    id="Password"
                    name="password"
                    class="mt-1 w-full rounded-md py-3 px-2 border-gray-200 bg-white text-sm text-black shadow-sm dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200"
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <input
                    onChange={handleConfirmPassword} className="form-control" placeholder="Enter Password Again"
                    type="password"
                ...
                <div class="col-span-6">
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <a href="#" class="ml-1 mr-1 text-gray-700 underline dark:text-gray-200">
                      terms and conditions
                    </a>
                    and
                    <a href="#" class="ml-1 text-gray-700 underline dark:text-gray-200">privacy policy</a>.
                  </p>
                </div>
                ...
                <div class="col-span-6 sm:flex flex-col sm:items-center sm:gap-4">
                  ...
                  <p class="mt-4 text-sm text-gray-500 sm:mt-0 dark:text-gray-400">
                    ...
                    <Link to="/login" className="text-merogreen underline pl-2">Login</Link>
                    {/* <a href="/login" class="text-merogreen underline pl-2">Log in</a>. */}
                  </p>
                </div>
              </form>
            </div>
